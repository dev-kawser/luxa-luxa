...
const Gallery = () => {
    ...
    return (
        <section className="py-6 mt-20 dark:bg-gray-100 dark:text-gray-900">
            ...
            <div className="container animate__animated animate__bounceIn grid grid-cols-2 gap-4 p-4 mx-auto md:grid-cols-4">
                ...
                <img alt="" className="w-full h-full rounded shadow-sm min-h-48 dark:bg-gray-500 aspect-square" src="https://i.ibb.co/6Rrz4Sz/Villa.jpg" />
                <img alt="" className="w-full h-full rounded shadow-sm min-h-48 dark:bg-gray-500 aspect-square" src="https://i.ibb.co/jJHrt7j/Private-Island.webp" />
                <img src="https://i.ibb.co/4JPJwNW/Resort.webp" alt="" className="w-full h-full col-span-2 row-span-2 rounded shadow-sm min-h-96 md:col-start-1 md:row-start-3 dark:bg-gray-500 aspect-square" />
            </div>
        </section>
    );
};

    ...
    return (
        <>
            ...
            <div className="p-6 lg:mt-20 sm:p-12 dark:bg-gray-50 dark:text-gray-800">
                ...
                <section className="py-6 mt-5 dark:bg-gray-100 dark:text-gray-800">
                    <div className="container flex flex-col items-center justify-center p-4 mx-auto sm:p-10">
                        ...
                        <div data-aos="zoom-in" className="flex flex-row flex-wrap-reverse justify-center mt-8">
